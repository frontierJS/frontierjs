...
**The doctrine is `PHILOSOPHY.md` and it is not repeated here.** Read § V (the nine questions), § IV (the six standing adjudications) and § VII (which kind of document may hold the answer) before answering anything. A skill that restated them would be a second origin for the material that exists to forbid second origins.
