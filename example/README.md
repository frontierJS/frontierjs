...
all 39 assertions passed        bun run verify:site      (the built static site)
    ...
    94 passed, 0 failed         bun run verify:money    (the discount, the delivery and the tax)
...
checkout link grew a credential of its own, and three the day its money
stopped being a Float:
