// api/src/providers/stripe/index.ts — the Stripe connection, both directions.
//
...
/** Where Stripe is. `api/src/providers/stripe/sink.ts` unless pointed at the real one. */
