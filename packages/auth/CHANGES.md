...
## 2026-08-02 → 2026-08-06 — findings, ranked by cost of being wrong, all fixed
...
*`FJS-002` (cookie auth) and `FJS-042` (auth events) are both closed now, in
`../../ISSUES_ARCHIVE.md`. **`FJS-063`** closed 2026-08-16, both halves, and
**`FJS-296`** was filed and closed out of it. `FJS-D20` is a ruling, in
`../../DECISIONS.md`. The writeups below are the argued detail.*
