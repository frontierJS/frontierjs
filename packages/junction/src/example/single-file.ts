...
//   • Service with full CRUD via createLitestoneService()
...
// Service code reads it via createLitestoneService — no manual plumbing needed.
...
app.services.register(
  createLitestoneService({
    ...
    // the per-request scoped Litestone client via ctx.params.db (set by
