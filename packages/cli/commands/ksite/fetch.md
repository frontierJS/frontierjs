...
alias: fetch
examples:
  - fli ksite:fetch https://example.com/about
  - fli ksite:fetch --from https://example.com/sitemap.xml
  - fli ksite:fetch --config ./scrape.config.js
  - fli ksite:fetch https://example.com/about --meta-only
  - fli ksite:fetch --config ./scrape.config.js --limit 5 --dry
  - fli ksite:fetch --from https://example.com/sitemap.xml --prefix blog
  - fli ksite:fetch --from https://example.com/sitemap.xml --strip /posts --prefix blog
args:
  -
    name: target
