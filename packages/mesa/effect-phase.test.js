...
// Tagging renders instead of user effects broke exactly that, and compiler_test
// caught it.
...
beforeAll(async () => {
  ...
  ;({ createSignal, createEffect, render, flushSync, ifBlock } = await import('./runtime.js'))
})
