...
import { renderFile } from './render-component.js'
import {
...
async function build(src) {
  ...
  const js = ctx.result.replace(/'@frontierjs\/mesa\/runtime\.js'/g, `'./runtime.js'`)
  ...
  async function bothRenderers(name, entrySrc) {
    ...
    for (const mod of ['SlotLayout', 'PropLayout', 'Page', name]) {
      ...
      writeFileSync(path.join(dir, `${mod}.mjs`), ctx.result
        .replace(/'@frontierjs\/mesa\/runtime\.js'/g, `'../runtime.js'`)
