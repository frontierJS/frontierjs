...
<!-- generated by: junction surface --app example/api/src/app.ts --services example/api/src/services -->

Generated from `example/api/src/app.ts` by `junction surface`. **Do not edit.**
...
```
20 services · 26 routes · 10 plugins · prefix /api
```
